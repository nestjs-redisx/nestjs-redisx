  ...
  defineConfig({
    ...
    themeConfig: {
      ...
      nav: [
        ...
        { text: 'v1.13.0', link: 'https://github.com/nestjs-redisx/nestjs-redisx/releases' },
      ],
      ...
      sidebar: {
        ...
        '/en/reference/': [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'Overview', link: '/en/reference/circuit-breaker/' },
              { text: 'Core Concepts', link: '/en/reference/circuit-breaker/concepts' },
              { text: 'Configuration', link: '/en/reference/circuit-breaker/configuration' },
              { text: '@WithCircuitBreaker Decorator', link: '/en/reference/circuit-breaker/decorator' },
              { text: 'Service API', link: '/en/reference/circuit-breaker/service-api' },
              { text: 'Algorithm', link: '/en/reference/circuit-breaker/algorithm' },
              { text: 'Monitoring', link: '/en/reference/circuit-breaker/monitoring' },
